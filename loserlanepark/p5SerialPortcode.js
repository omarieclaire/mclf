// What it does:
// Connects web browsers to Arduino devices through a WebSocket server. Since browsers can't directly access serial ports for security reasons, this library uses an intermediary server that:

// Connects to your Arduino via USB/serial port
// Runs a WebSocket server (typically on localhost:8081)
// Relays data between your web browser and Arduino in both directions

// Key Features:
// Reading from Arduino:

// read() - gets individual bytes
// readString() - gets text data
// readLine() - reads until newline (great for sensor data)
// available() - checks how much data is waiting

// Writing to Arduino:

// write() - sends data to Arduino (numbers, strings, arrays)

// Connection Management:

// list() - shows available serial ports
// open() - connects to specific port
// close() - disconnects
