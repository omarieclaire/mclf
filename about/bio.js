...
<p>I did a residency at the Société des arts technologiques <a target="_blank" href="https://sat.qc.ca/en/metalab">Metalab</a> and made <a target="_blank" href="https://marieflanagan.com/come-with-me/">ComeWithMe</a>, a strange game exploring connection and the spaces between people (I wrote a blog post about getting <a target="_blank" href="https://marieflanagan.com/stuck/">stuck</a> along the way).</p>
 <p>I created <a target="_blank" href="https://tendercircuits.ca/home/indexx/">Tender Circuits</a> for <a target="_blank" href="https://digitalartsresourcecentre.ca/">DARC</a>, a web experience documenting the work of artists exploring the concept of connection and fungal intelligence through participating in AR app development. </p>
 <p>I co-created <a target="_blank" href="https://www.instagram.com/p/Cd1LID2pTDi/">Song of the Soil</a> with Dirtpunk (Henry Driver, Rebecka Pettersson, Ashley Cho, and Sacha Holsnyder) about <a target="_blank" href="https://instagram.com/p/CdEIKmNpg6o/">microbes and fungus</a> and the beauty of <a target="_blank" href="https://twitter.com/omarieclaire/status/1521181177704558594">soil</a> for IndieCade's Climate Jam, and we won the Most Adventurous/Innovative award</p>
 <p>I worked with Leslie Ting to create <a target="_blank" href="http://summerworks.ca/show/what-brings-you-in/">What Brings You In</a>, an interactive online show with music, live narration, guest voices, and playful interactions. </p>
 <p>I worked with You Are Swimming Here</p>
 <p>We celebrated the 8th annual drone day, and I organized the first ever <a target="_blank" href="LINK">Drone Jam</a>, where we made experimental games, toys, or playful things related to the idea of sustained tones. You can play the <a target="_blank" href="LINK">drone games here</a>.</p>
 <p>I worked with TruLuv on Design for #selfcare, incorporating rituals to deepen care, compassion, and connection.</p>
 <p>I worked with Long Winter, a music and arts monthly shoxwcase in Toronto featuring music, visual art, large scale installation, video, performance art, theatre, dance, new media and xR. </p>
 <p>I co-organized 2022 Virtual CC Fest with Saber Khan, a virtual online creative coding event.</p>
 <p>I hosted a play session for artists few events for artists ​​exploring feelings around ai / ethics / being here now as we tried out new AI tools. </p>
 <p>I co-organized with Ada X, and InterAccess Ctrl+Shift: Data Sovereignty & Community Action, conversations about listening, inquiring, contemplating, and consent-building in the age of digital giants.</p>
 <p>I hosted conversations with six artists in the X-Camera series to discuss their artistic practice.</p>
 <p>I organized a series of workshops called "playsessions" on making experimental games, including Concentric Fictions with Dhruv Jani, exploring magical realism, experimentation, and nonsense verse; Weird Theatre Games workshop with D. Squinkifer, a workshop about transforming emotionally challenging situations into one-of-a-kind awkward theatre games; Making It Work: Tools & Modes for Interactive Experiences, a workshop about designing playful interactive experiences with Jess Rowan Marcotte; and an online workshop exploring 3D creation in Blender and ZBrush with Anna Eyer.</p>
 <p>I created a series of sessions on funding games, including How to Finance Your Game without Going into Debt with Meagan Byrne, a workshop about financing games for small indie game studios.</p>
 <p>
